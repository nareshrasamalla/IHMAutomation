...
public class TS_NS_6707_RemoveAgencyCommission extends BaseReport {

	private BaseTest basetest;
	public static Excel_Reader excelReader;
	public static int i = 6707;
	...
	public void removeAgencyCommission() throws InterruptedException, IOException, AWTException {
		...
		driver = oLoginPage.LaunchNetSuiteApp(XLTestData.get("NetSuite_URL").toString(), XLTestData, filePathToDownload,
				basetest);
		// Login Application
